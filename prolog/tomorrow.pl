...
template_applicable(Task, retain) :-
    ...
    English \= "",
    ( phrase(english_form(Constraints), English) ->
...
:- multifile julian_lang_en:english_form//1.
julian_lang_en:english_form(month([september,october,november,december,january,february,march,april])) -->
    "school year".
